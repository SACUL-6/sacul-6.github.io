function HTMLActuator() {
  (this.tileContainer = document.getElementsByClassName("tile-container")[0]),
    (this.scoreContainer =
      document.getElementsByClassName("score-container")[0]),
    (this.messageContainer =
      document.getElementsByClassName("game-message")[0]),
    (this.sharingContainer =
      document.getElementsByClassName("score-sharing")[0]),
    (this.score = 0);
}
(HTMLActuator.prototype.actuate = function (t, e) {
  ...
  (HTMLActuator.prototype.addTile = function (t) {
    var e = this,
      ...
      n = t.previousPosition || { x: t.x, y: t.y };
    ...
    this.applyClasses(o, s),
      ...
      t.previousPosition
        ? window.requestAnimationFrame(function () {
            (s[2] = e.positionClass({ x: t.x, y: t.y })), e.applyClasses(o, s);
          })
        : t.mergedFrom
        ? (s.push("tile-merged"),
          this.applyClasses(o, s),
        ...
        : (s.push("tile-new"), this.applyClasses(o, s)),
  ...
  (HTMLActuator.prototype.scoreTweetButton = function () {
    ...
    var e =
      "I scored " +
      this.score +
      " points at 2048, a game where you join numbers to score high! #2048game #2048ai";
