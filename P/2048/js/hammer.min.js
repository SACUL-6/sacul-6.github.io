...
!(function (t, e) {
  ...
  (n.defaults = {
    ...
    (n.HAS_POINTEREVENTS =
      t.navigator.pointerEnabled || t.navigator.msPointerEnabled),
    (n.HAS_TOUCHEVENTS = "ontouchstart" in t),
    (n.MOBILE_REGEX = /mobile|tablet|ip(ad|hone|od)|android|silk/i),
    (n.NO_MOUSEEVENTS =
      n.HAS_TOUCHEVENTS && t.navigator.userAgent.match(n.MOBILE_REGEX)),
    (n.EVENT_TYPES = {}),
      ...
      each: function (t, n, i) {
        ...
        if ("forEach" in t) t.forEach(n, i);
          ...
          for (r = 0, o = t.length; o > r; r++)
            if (!1 === n.call(i, t[r], r, t)) return;
        } else
          for (r in t)
            if (t.hasOwnProperty(r) && !1 === n.call(i, t[r], r, t)) return;
      },
    ...
    (n.Instance = function (t, e) {
      ...
      return (
        ...
        (this.element = t),
        (this.enabled = !0),
        (this.options = n.utils.extend(
          n.utils.extend({}, n.defaults),
          e || {}
        )),
        this.options.stop_browser_behavior &&
          n.utils.stopDefaultBrowserBehavior(
            this.element,
            this.options.stop_browser_behavior
          ),
    ...
    (n.Instance.prototype = {
      ...
      trigger: function (t, e) {
        ...
        var r = this.element;
        return (
          n.utils.hasParent(e.target, r) && (r = e.target),
          r.dispatchEvent(i),
          this
        );
      },
  ...
  (n.event = {
      ...
      this.bindDom(t, n.EVENT_TYPES[e], function (c) {
        ...
        if (!u.match(/mouse/) || !o) {
          ...
          (u.match(/mouse/) && 1 === c.which)
            ? (r = !0)
            : u.match(/mouse/) && !c.which && (r = !1),
            u.match(/touch|pointer/) && (o = !0);
          var h = 0;
          r &&
            (n.HAS_POINTEREVENTS && e != n.EVENT_END
              ? (h = n.PointerEvent.updatePointer(e, c))
              : u.match(/touch/)
              ? (h = c.touches.length)
              : o || (h = u.match(/up/) ? 0 : 1),
            h > 0 && e == n.EVENT_END
            ...
            s.call(
              n.detection,
              a.collectEventData(t, e, a.getTouchList(i, e), c)
            ),
            n.HAS_POINTEREVENTS &&
              e == n.EVENT_END &&
              (h = n.PointerEvent.updatePointer(e, c))),
            h || ((i = null), (r = !1), (o = !1), n.PointerEvent.reset());
        }
      });
    },
    ...
    getTouchList: function (t) {
      return n.HAS_POINTEREVENTS
        ? n.PointerEvent.getTouchList()
        : t.touches
        ? t.touches
        : ((t.identifier = 1), [t]);
    },
    collectEventData: function (t, e, i, r) {
      ...
      return (
        (r.type.match(/mouse/) ||
          n.PointerEvent.matchType(n.POINTER_MOUSE, r)) &&
          (o = n.POINTER_MOUSE),
        {
    ...
    (n.PointerEvent = {
      ...
      getTouchList: function () {
        var t = [];
        return (
          n.utils.each(this.pointers, function (e) {
            t.push(e);
          }),
          t
        );
      ...
      matchType: function (t, e) {
        ...
        return (
          ...
          (r[n.POINTER_PEN] =
            i === e.MSPOINTER_TYPE_PEN || i === n.POINTER_PEN),
          r[t]
        );
      },
      getEvents: function () {
          ...
          return (
            n.utils.each(
              ...
              function (n) {
                return this.stopped ||
                  !1 === e[n.name] ||
                  !1 !== n.handler.call(n, t, this.current.inst)
                  ? void 0
                  : (this.stopDetect(), !1);
              },
              this
      ...
      extendEventData: function (t) {
        ...
        return (
          "end" === t.eventType
            ...
            : ((i =
                this.current.lastEvent &&
                n.utils.getAngle(this.current.lastEvent.center, t.center)),
              (r =
                this.current.lastEvent &&
                n.utils.getDirection(this.current.lastEvent.center, t.center))),
          n.utils.extend(t, {
            deltaTime: o,
            deltaX: s,
            deltaY: a,
    ...
    (n.gestures.Drag = {
      ...
      handler: function (t, e) {
        if (n.detection.current.name != this.name && this.triggered)
          return e.trigger(this.name + "end", t), void (this.triggered = !1);
        if (
          !(
            e.options.drag_max_touches > 0 &&
            t.touches.length > e.options.drag_max_touches
          )
        )
          switch (t.eventType) {
            case n.EVENT_START:
            ...
            case n.EVENT_MOVE:
              if (
                t.distance < e.options.drag_min_distance &&
              ...
              (n.detection.current.lastEvent.drag_locked_to_axis ||
                (e.options.drag_lock_to_axis &&
                  e.options.drag_lock_min_distance <= t.distance)) &&
                (t.drag_locked_to_axis = !0);
              var r = n.detection.current.lastEvent.direction;
              t.drag_locked_to_axis &&
                r !== t.direction &&
                (t.direction = n.utils.isVertical(r)
                  ? t.deltaY < 0
                    ? n.DIRECTION_UP
                    : n.DIRECTION_DOWN
                  : t.deltaX < 0
                  ...
                  : n.DIRECTION_RIGHT),
                this.triggered ||
                  (e.trigger(this.name + "start", t), (this.triggered = !0)),
                e.trigger(this.name, t),
                e.trigger(this.name + t.direction, t),
                ((e.options.drag_block_vertical &&
                  n.utils.isVertical(t.direction)) ||
                  (e.options.drag_block_horizontal &&
                    !n.utils.isVertical(t.direction))) &&
                  t.preventDefault();
              break;
            case n.EVENT_END:
      ...
      handler: function (t, e) {
        if (t.eventType == n.EVENT_END) {
          if (
            ...
            t.touches.length < e.options.swipe_min_touches &&
    ...
    (n.gestures.Touch = {
      ...
      handler: function (t, e) {
        return e.options.prevent_mouseevents && t.pointerType == n.POINTER_MOUSE
          ? void t.stopDetect()
          : (e.options.prevent_default && t.preventDefault(),
    ...
    (n.gestures.Transform = {
      ...
      handler: function (t, e) {
        ...
        if (!(t.touches.length < 2))
          switch (
            (e.options.transform_always_block && t.preventDefault(),
            t.eventType)
          ) {
            case n.EVENT_START:
              this.triggered = !1;
            ...
            case n.EVENT_MOVE:
              ...
              if (
                i < e.options.transform_min_scale &&
                r < e.options.transform_min_rotation
              )
                return;
              (n.detection.current.name = this.name),
                this.triggered ||
